...
const string strMessageMagic = "Operand Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Operand", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Clyde & Co global aviation finance head resigns";
        CTransaction txNew;
        txNew.nTime = 1436914394;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1456798617;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1384331 : 0;


 //// Debug print
        assert(block.hashMerkleRoot == uint256("0xcfd63c45802e19c5486e90d4cc18f6120970535e1a96d5a6abf787532186e773"));
...
unsigned char pchMessageStart[4] = { 0x02, 0xa4, 0x12, 0xb1 };
